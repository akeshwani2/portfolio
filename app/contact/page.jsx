...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+1) 470 685 2099",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "arhaankeshwani200@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
        ...
        <div className="xl:w-[54%] order-2 xl:order-none">
          <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
            ...
            <p className="text-white/60">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum, quis? Aliquid earum facere ipsam?
            </p>
            {/* input */}
